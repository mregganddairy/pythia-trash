//comparing pt plots from different pdfs 
#include "TFile.h"
...
static const double binedges[nbins+1] = {0., 150. };
	...
	TH1F* sub_Wm_10042_muon_cross_section = new TH1F("sub_Wm_10042_muon_cross_section","", 50,  0,100);
	TH1F* Wm_10042_muon_cross_section = new TH1F("Wm_10042_muon_cross_section","", 50,  0,100);

	TH1F* sub_Wm_10555_muon_cross_section = new TH1F("sub_Wm_10555_muon_cross_section","", 50,  0,100);
	TH1F* Wm_10555_muon_cross_section = new TH1F("Wm_10555_muon_cross_section","", 50,  0,100);

	TH1F* sub_Wm_14000_muon_cross_section = new TH1F("sub_Wm_14000_muon_cross_section","", 50,  0,100);
	TH1F* Wm_14000_muon_cross_section = new TH1F("Wm_14000_muon_cross_section","", 50,  0,100);

	TH1F* sub_Wm_27000_muon_cross_section = new TH1F("sub_Wm_27000_muon_cross_section","", 50,  0,100);
	TH1F* Wm_27000_muon_cross_section = new TH1F("Wm_27000_muon_cross_section","", 50,  0,100);

	TH1F* sub_Wm_315000_muon_cross_section = new TH1F("sub_Wm_315000_muon_cross_section","", 50,  0,100);
	TH1F* Wm_315000_muon_cross_section = new TH1F("Wm_315000_muon_cross_section","", 50,  0,100);

	TH1F* sub_Wm_315200_muon_cross_section = new TH1F("sub_Wm_315200_muon_cross_section","", 50,  0,100);
	TH1F* Wm_315200_muon_cross_section = new TH1F("Wm_315200_muon_cross_section","", 50,  0,100);

	TH1F* sub_Wm_331900_muon_cross_section = new TH1F("sub_Wm_331900_muon_cross_section","", 50,  0,100);
	TH1F* Wm_331900_muon_cross_section = new TH1F("Wm_331900_muon_cross_section","", 50,  0,100);

	TH1F* sub_Wm_10050_muon_cross_section = new TH1F("sub_Wm_10050_muon_cross_section","", 50,  0,100);
	TH1F* Wm_10050_muon_cross_section = new TH1F("Wm_10050_muon_cross_section","", 50,  0,100);


	// W plus histograms for different pdfs
	TH1F* sub_Wp_10042_muon_cross_section = new TH1F("sub_Wp_10042_muon_cross_section","", 50,  0,100);
	TH1F* Wp_10042_muon_cross_section = new TH1F("Wp_10042_muon_cross_section","", 50,  0,100);

	TH1F* sub_Wp_10555_muon_cross_section = new TH1F("sub_Wp_10555_muon_cross_section","", 50,  0,100);
	TH1F* Wp_10555_muon_cross_section = new TH1F("Wp_10555_muon_cross_section","", 50,  0,100);

	TH1F* sub_Wp_14000_muon_cross_section = new TH1F("sub_Wp_14000_muon_cross_section","", 50,  0,100);
	TH1F* Wp_14000_muon_cross_section = new TH1F("Wp_14000_muon_cross_section","", 50,  0,100);

	TH1F* sub_Wp_27000_muon_cross_section = new TH1F("sub_Wp_27000_muon_cross_section","", 50,  0,100);
	TH1F* Wp_27000_muon_cross_section = new TH1F("Wp_27000_muon_cross_section","", 50,  0,100);

	TH1F* sub_Wp_315000_muon_cross_section = new TH1F("sub_Wp_315000_muon_cross_section","", 50,  0,100);
	TH1F* Wp_315000_muon_cross_section = new TH1F("Wp_315000_muon_cross_section","", 50,  0,100);

	TH1F* sub_Wp_315200_muon_cross_section = new TH1F("sub_Wp_315200_muon_cross_section","", 50,  0,100);
	TH1F* Wp_315200_muon_cross_section = new TH1F("Wp_315200_muon_cross_section","", 50,  0,100);

	TH1F* sub_Wp_331900_muon_cross_section = new TH1F("sub_Wp_331900_muon_cross_section","", 50,  0,100);
	TH1F* Wp_331900_muon_cross_section = new TH1F("Wp_331900_muon_cross_section","", 50,  0,100);

	TH1F* sub_Wp_10050_muon_cross_section = new TH1F("sub_Wp_10050_muon_cross_section","", 50,  0,100);
	TH1F* Wp_10050_muon_cross_section = new TH1F("Wp_10050_muon_cross_section","", 50,  0,100);


	// Z histograms for different pdfs
	TH1F* sub_Z_10042_muon_cross_section = new TH1F("sub_Z_10042_muon_cross_section","", 50,  0,100);
	TH1F* Z_10042_muon_cross_section = new TH1F("Z_10042_muon_cross_section","", 50,  0,100);

	TH1F* sub_Z_10555_muon_cross_section = new TH1F("sub_Z_10555_muon_cross_section","", 50,  0,100);
	TH1F* Z_10555_muon_cross_section = new TH1F("Z_10555_muon_cross_section","", 50,  0,100);

	TH1F* sub_Z_14000_muon_cross_section = new TH1F("sub_Z_14000_muon_cross_section","", 50,  0,100);
	TH1F* Z_14000_muon_cross_section = new TH1F("Z_14000_muon_cross_section","", 50,  0,100);

	TH1F* sub_Z_27000_muon_cross_section = new TH1F("sub_Z_27000_muon_cross_section","", 50,  0,100);
	TH1F* Z_27000_muon_cross_section = new TH1F("Z_27000_muon_cross_section","", 50,  0,100);

	TH1F* sub_Z_315000_muon_cross_section = new TH1F("sub_Z_315000_muon_cross_section","", 50,  0,100);
	TH1F* Z_315000_muon_cross_section = new TH1F("Z_315000_muon_cross_section","", 50,  0,100);

	TH1F* sub_Z_315200_muon_cross_section = new TH1F("sub_Z_315200_muon_cross_section","", 50,  0,100);
	TH1F* Z_315200_muon_cross_section = new TH1F("Z_315200_muon_cross_section","", 50,  0,100);

	TH1F* sub_Z_331900_muon_cross_section = new TH1F("sub_Z_331900_muon_cross_section","", 50,  0,100);
	TH1F* Z_331900_muon_cross_section = new TH1F("Z_331900_muon_cross_section","", 50,  0,100);

	TH1F* sub_Z_10050_muon_cross_section = new TH1F("sub_Z_10050_muon_cross_section","", 50,  0,100);
	TH1F* Z_10050_muon_cross_section = new TH1F("Z_10050_muon_cross_section","", 50,  0,100);
...
//*******************************************************************************
	...
	//if ((eta > -4.0) && (eta < -2.5)){
		...
		{
			sub_Wm_10042_muon_cross_section->Fill(pt);
		}
	...
	//if ((eta > -4.0) && (eta < -2.5)){
		...
		if ((abs(mother1) == 24) || ((abs(mother1) == 13) && (abs(mother2) == 90)))
		{
			sub_Wm_10555_muon_cross_section->Fill(pt);
		}
	...
	//if ((eta > -4.0) && (eta < -2.5)){
		...
		if ((abs(mother1) == 24) || ((abs(mother1) == 13) && (abs(mother2) == 90)))
		{
			sub_Wm_14000_muon_cross_section->Fill(pt);
		}
	...
	//if ((eta > -4.0) && (eta < -2.5)){
		...
		if ((abs(mother1) == 24) || ((abs(mother1) == 13) && (abs(mother2) == 90)))
		{
			sub_Wm_27000_muon_cross_section->Fill(pt);
		}
	...
	//if ((eta > -4.0) && (eta < -2.5)){
		...
		if ((abs(mother1) == 24) || ((abs(mother1) == 13) && (abs(mother2) == 90)))
		{
			sub_Wm_315200_muon_cross_section->Fill(pt);
		}
	...
	//if ((eta > -4.0) && (eta < -2.5)){
		...
		if ((abs(mother1) == 24) || ((abs(mother1) == 13) && (abs(mother2) == 90)))
		{
			sub_Wm_331900_muon_cross_section->Fill(pt);
		}
	...
	//if ((eta > -4.0) && (eta < -2.5)){
		...
		if ((abs(mother1) == 24) || ((abs(mother1) == 13) && (abs(mother2) == 90)))
		{
			sub_Wm_10050_muon_cross_section->Fill(pt);
		}
...
//*******************************************************************************
	...
	//if ((eta > -4.0) && (eta < -2.5)){
		...
		if ((abs(mother1) == 24) || ((abs(mother1) == 13) && (abs(mother2) == 90)))
		{
			sub_Wp_10042_muon_cross_section->Fill(pt);
		}
	...
	//if ((eta > -4.0) && (eta < -2.5)){
		...
		if ((abs(mother1) == 24) || ((abs(mother1) == 13) && (abs(mother2) == 90)))
		{
			sub_Wp_10555_muon_cross_section->Fill(pt);
		}
	...
	//if ((eta > -4.0) && (eta < -2.5)){
		...
		if ((abs(mother1) == 24) || ((abs(mother1) == 13) && (abs(mother2) == 90)))
		{
			sub_Wp_14000_muon_cross_section->Fill(pt);
		}
	...
	//if ((eta > -4.0) && (eta < -2.5)){
		...
		if ((abs(mother1) == 24) || ((abs(mother1) == 13) && (abs(mother2) == 90)))
		{
			sub_Wp_27000_muon_cross_section->Fill(pt);
		}
	...
	//if ((eta > -4.0) && (eta < -2.5)){
		...
		if ((abs(mother1) == 24) || ((abs(mother1) == 13) && (abs(mother2) == 90)))
		{
			sub_Wp_315200_muon_cross_section->Fill(pt);
		}
	...
	//if ((eta > -4.0) && (eta < -2.5)){
		...
		if ((abs(mother1) == 24) || ((abs(mother1) == 13) && (abs(mother2) == 90)))
		{
			sub_Wp_331900_muon_cross_section->Fill(pt);
		}
	...
	//if ((eta > -4.0) && (eta < -2.5)){
		...
		if ((abs(mother1) == 24) || ((abs(mother1) == 13) && (abs(mother2) == 90)))
		{
			sub_Wp_10050_muon_cross_section->Fill(pt);
		}
...
//*******************************************************************************
	...
	//if ((eta > -4.0) && (eta < -2.5)){
		...
		if ((abs(mother1) == 24) || ((abs(mother1) == 13) && (abs(mother2) == 90)))
		{
			sub_Z_10042_muon_cross_section->Fill(pt);
		}
	...
	//if ((eta > -4.0) && (eta < -2.5)){
		...
		if ((abs(mother1) == 24) || ((abs(mother1) == 13) && (abs(mother2) == 90)))
		{
			sub_Z_10555_muon_cross_section->Fill(pt);
		}
	...
	//if ((eta > -4.0) && (eta < -2.5)){
		...
		if ((abs(mother1) == 24) || ((abs(mother1) == 13) && (abs(mother2) == 90)))
		{
			sub_Z_14000_muon_cross_section->Fill(pt);
		}
	...
	//if ((eta > -4.0) && (eta < -2.5)){
		...
		if ((abs(mother1) == 24) || ((abs(mother1) == 13) && (abs(mother2) == 90)))
		{
			sub_Z_27000_muon_cross_section->Fill(pt);
		}
	...
	//if ((eta > -4.0) && (eta < -2.5)){
		...
		if ((abs(mother1) == 24) || ((abs(mother1) == 13) && (abs(mother2) == 90)))
		{
			sub_Z_315200_muon_cross_section->Fill(pt);
		}
	...
	//if ((eta > -4.0) && (eta < -2.5)){
		...
		if ((abs(mother1) == 24) || ((abs(mother1) == 13) && (abs(mother2) == 90)))
		{
			sub_Z_331900_muon_cross_section->Fill(pt);
		}
	...
	//if ((eta > -4.0) && (eta < -2.5)){
		...
		if ((abs(mother1) == 24) || ((abs(mother1) == 13) && (abs(mother2) == 90)))
		{
			sub_Z_10050_muon_cross_section->Fill(pt);
		}
	...
	Wm_10042_muon_cross_section->SetMaximum(1000);
	c3->Write();
	...
	Wp_10042_muon_cross_section->SetMaximum(1000);
	c4->Write();
	...
	Z_10042_muon_cross_section->SetMaximum(1000);
	c5->Write();
